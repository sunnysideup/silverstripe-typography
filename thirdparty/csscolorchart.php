...
class csscolorchart
{
    ...
    protected function displayColors()
    {
        ...
        foreach ($this->matchResults as $color => $matches) {
            ...
            <div class="colorSwatch expand-button-for-colours" style="background-color: #' . $color . '" data-color="' . $color . '"></div>
            <div class="colorName">#' . $color . '</div>
            <div class="colorToggle"><a href="#" data-color="' . $color . '" class="expand-button-for-colours">view ' . count($matches) . ' matches</a></div>
